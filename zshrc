...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting aws docker docker-compose kubectl python pip terraform git terraform)
...
alias ks='ls'
alias cs='clear'
alias pass_gen='openssl rand -base64 20'
alias gen_pass='openssl rand -base64 20'
alias rgep='grep'
alias got='git'
alias vom='vim'
alias vm='vim'
